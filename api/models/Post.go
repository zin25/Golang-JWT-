...
type Post struct {
	...
	Types 	string`gorm:"not null" json:"types"`
...
func (p *Post) Prepare() {
	...
	p.Types = html.EscapeString(strings.TrimSpace(p.Types))
	p.Author = User{}
...
func (p *Post) Validate() error {
	...
	if p.Types != "Artikel" && p.Types != "Idea"{
		return errors.New("Required Types")
	}
	if p.AuthorID < 1 {
